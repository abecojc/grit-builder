...
const LinkR = (e)=> {
    e.preventDefault();
    window.alert("Thanks for submitting your Comment")
        ...
        <>
            ...
            <div className="flex flex-col justify-center bg-blue-300 ">
                ...
                <div className="w-96  mb-24 mx-12">
                    <form className="border-white border-2 rounded-xl" onSubmit={LinkR}>
                        <div className="flex flex-col justify-between">
                            ...
                            <div className="m-2 flex flex-col ">
                                ...
                                <input type="text" id="email" className="emailAddress rounded-xl m-2 p-2 px-12"
                                       placeholder="Your email address.."/>
                            </div>
                            <div className="m-2 flex flex-col">
                                <label htmlFor="subject">Comment</label>
                                <textarea id="subject" name="subject" className="h-24  m-2 rounded-xl p-2 w-9/10"
