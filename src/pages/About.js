    ...
    <>
        ...
        <div className="p-4 mb-12 bg-blue-300">
            ...
            <div>
                ...
                <div className="my-2 flex text-xl border-2 border-black rounded-xl p-2 font-bold ">Our story</div>
                <p className="border-2 border-black rounded-xl p-2" >
                ...
                <div className="my-2 flex border-2 border-black rounded-xl p-2 text-xl font-bold ">Team Member Profiles</div>
                <p className="border-2 border-black rounded-xl p-2" >
