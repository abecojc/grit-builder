    ...
    <>
        ...
        <div className="p-4 h-screen mb-12 ">
            ...
            <div>
                ...
                <div className="bg-blue-300 my-2 w-1/4 flex text-xl border-2 border-black rounded-xl p-2 font-bold"> Vision and Mission</div>
                <p className="bg-blue-300 border-2 border-black rounded-xl p-2 " >
                ...
                <div className="bg-blue-300 my-2 w-1/4 flex text-xl border-2 border-black rounded-xl p-2 font-bold ">Our story</div>
                <p className="bg-blue-300 border-2 border-black rounded-xl p-2" >
                ...
                <div className="bg-blue-300 my-2 w-1/4 flex border-2 border-black rounded-xl p-2 text-xl font-bold ">Team Member Profiles</div>
                <p className="bg-blue-300 border-2 border-black rounded-xl p-2" >
                    This area will ihave our proud member testimonials. Add an emotional element to your About Us page by adding details of the people that are driving the passion at your business. People find it easier to connect with human beings, so allow the personality of your crew to shine through the About Us page.
                </p>
